...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmlzaGFiZHVnYXIiLCJhIjoiY2t3NmY2cTh3MWlxajJ3cDZxa3VvaXlteiJ9.DNvx_nfnyGiYekihwnr2AA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Extends the map bounds
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              // <- 3rd Party library that makes the AJAx calls
              method: 'POST',
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Error loggin out! Please try again later');
            console.log(_context2.t0); //console.log(res);
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              method: 'PATCH',
              // <- Axios also triggers the errors
              url: "".concat(type === 'data' ? 'http://127.0.0.1:3000/api/v1/users/updateMyData' : 'http://127.0.0.1:3000/api/v1/users/updateMyPassword'),
              data: data
            });
...
var updateSettingsForm = document.querySelector('.form-user-settings'); // Values ->>
// Dedication ->>
